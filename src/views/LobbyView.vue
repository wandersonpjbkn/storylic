...
<template>
  <div class="flex flex-col gap-4 pb-4">
    ...
    <div class="sl-surface px-5 py-4">
      <div class="flex items-center justify-between mb-4">
        ...
        <span
          ...
          style="background:rgba(168,85,247,0.20);color:#d8b4fe;border:1px solid rgba(168,85,247,0.25)"
        >{{ storeSocket.room.length }} jogador{{ storeSocket.room.length !== 1 ? 'es' : '' }}</span>
      </div>
      ...
      <div class="flex flex-col gap-2">
        <div
          ...
          :style="player.id === storeSocket.myPlayerNumber
        ...
        >
          ...
          <span
            ...
            :style="player.id === storeSocket.myPlayerNumber ? 'color:#e9d5ff' : 'color:rgba(255,255,255,0.80)'"
          >{{ player.name }}</span>
        ...
        <div
          ...
          style="color:rgba(255,255,255,.30);font-size:13px"
        >Aguardando jogadores...</div>
      </div>

      <!-- Nota explicativa -->
      <p class="text-xs mt-3" style="color:rgba(255,255,255,.35)">
    ...
    <p class="text-xs text-center" style="color:rgba(255,255,255,.35)">
