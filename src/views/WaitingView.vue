...
interface Card { name: string; category: string }
...
onUnmounted(() => { storeSocket.socket?.off('player-selected-cards') })
</script>
...
<template>
  <div class="flex flex-col gap-4 pb-4">
    ...
    >
      ...
      <p class="text-sm" style="color:rgba(255,255,255,.75)">Você será avisado quando for sua vez</p>
    </div>
